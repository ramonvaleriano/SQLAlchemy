...
ingredientes_picole = sqlalchemy.Table(
    ...
    sqlalchemy.Column('id_ingrediente', sqlalchemy.Integer, sqlalchemy.ForeignKey('ingredientes.id'))
)
...
conservantes_picole = sqlalchemy.Table(
    ...
    ModelBase.metadata,
    sqlalchemy.Column('id_picole', sqlalchemy.Integer, sqlalchemy.ForeignKey('picoles.id')),
    sqlalchemy.Column('id_conservante', sqlalchemy.Integer, sqlalchemy.ForeignKey('conservante.id'))
)
